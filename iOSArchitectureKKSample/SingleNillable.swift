...
public enum SingleNillableTrait { }
/// Represents a push style sequence containing 1 element.
public typealias SingleNillable<Element> = PrimitiveSequence<SingleTrait, Element?>
...
extension PrimitiveSequenceType where TraitType == SingleNillableTrait {
